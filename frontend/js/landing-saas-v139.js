...
(function () {
  ...
  const dict = {
    en: {
      ...
      selectedProofRealtime: "Current project signals in one dashboard",
      selectedProofMetrics: "Plan, actual, cost and risk checks",
      selectedProofSecure: "Secure uploads and report access",
      ...
      accessText: "Single Project is a one-time checkout for one uploaded project and one completed dashboard result. Plus and Pro add recurring credits, saved reports and workspace history.",
      ...
      flowPaymentText: "Single Project buys one completed analysis. Plus and Pro add monthly analysis credits for repeated project reviews.",
      flowUploadTitle: "Upload & dashboard",
      flowUploadText: "Upload the files required for your selected package. The package decides which dashboard sections and outputs are generated.",
      ...
      pricingTitle: "Choose how you want to receive project results.",
      pricingText: "Single Project unlocks one completed dashboard and report package. Plus and Pro are monthly workspace plans for repeated project reviews.",
      pkgSingleType: "One-time",
      pkgSingleBadge: "No subscription",
      pkgSingleUnit: "project analysis",
      pkgSinglePricePeriod: "one-time / project",
      pkgSingleDesc: "Best for one project review. Upload one project, confirm the detected data, and unlock one completed dashboard with PDF or Excel outputs.",
      pkgMonthlyType: "Monthly",
      pkgPopularBadge: "Recommended",
      pkgPlusUnit: "projects / month",
      pkgPlusDesc: "For small teams that review projects every month and need saved reports, recurring credits and workspace history.",
      pkgProBadge: "Higher volume",
      pkgProUnit: "projects / month",
      pkgProDesc: "For companies managing multiple active sites and needing stronger reporting volume, archive control and usage visibility.",
      ...
      pkgProCta: "Start Pro",
      paymentNote: "Single Project is $29 one time for one uploaded project and one completed result. Plus is $49/month for 5 analyses. Pro is $89/month for 20 analyses.",
      singleEntryBadge: "Single Project selected",
      singleEntryTitle: "Upload one project first. Pay only when you are ready to unlock the completed result.",
      singleEntryText: "No account required. Single Project gives you one uploaded project, one completed dashboard and one report package for $29.",
    ...
    az: {
      ...
      selectedProofRealtime: "Cari layihə siqnalları tək dashboardda",
      selectedProofMetrics: "Plan, fakt, xərc və risk yoxlamaları",
      selectedProofSecure: "Təhlükəsiz yükləmə və hesabat girişi",
