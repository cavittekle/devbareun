...
(function () {
  ...
  const t = {
    en: {
      ...
      packageMaterialKicker: "Material + Procurement",
      ...
      packageCostKicker: "Cost Estimate + Progress Payment",
      packageFullKicker: "All control modules",
      ...
      packageComboText: "Complete project-control view for executive decisions and reporting.",
      ...
      template_all_text: "Upload cost estimate, progress payment, schedule, workforce, material or risk files. The professional template includes separate sheets for each data type.",
      template_cost_title: "Cost & Payment Control",
      template_cost_text: "Upload cost estimate / smeta baseline plus progress payment or actual cost data. DevBareun compares approved budget, completed amount, remaining value and payment risk.",
      ...
      template_material_text: "Upload material stock, delivery, procurement or consumption data. DevBareun highlights shortages, delivery risks and continuity actions.",
      template_risk_title: "Risk & Decisions",
      template_risk_text: "Upload risk logs, site notes, cost/schedule signals or decision records. DevBareun creates a decision-focused risk dashboard.",
      ...
      template_progress_text: "Upload progress payment records, plan/fact reports or completed work tables. Professional template is optional; you can also upload your own files."
    },
    az: {
      ...
      packageMaterialKicker: "Material + Təchizat",
      ...
      packageFullKicker: "Bütün nəzarət modulları",
